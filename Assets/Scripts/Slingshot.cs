...
public class Slingshot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Line.SetPosition(1, new Vector3(Bird.transform.position.x - 0.5f, Bird.transform.position.y, Bird.transform.position.z + 0.1f));
            Line.SetPosition(2, new Vector3(Bird.transform.position.x, Bird.transform.position.y, Bird.transform.position.z - 0.3f));
            Line.SetPosition(3, new Vector3(Bird.transform.position.x + 0.5f, Bird.transform.position.y, Bird.transform.position.z + 0.1f));
        }
